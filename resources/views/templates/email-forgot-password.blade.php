...
<head>
    ...
    <title>Forgot Password - Tonsaeay</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <p class="or-text">To reset your password, click the link below:</p>

            <a href="{{$resetUrl}}" class="confirm-button">Reset Password</a>

            <p class="footer-text">If you didn't try to reset password in Tonsaeay Chat, please ignore this message.</p>
        </div>
    </div>
</body>
</html>
